...
def admin_control():
    ...
    add_remove_admin_button = ttk.Button(
        window,
        text="Update-Password/Add/Remove Admin",
    ...
    try:
        hfb_logo_label = ttk.Label(window, image=hfb_logo)
        hfb_logo_label.image = hfb_logo
        hfb_logo_label.grid(
            row=0,
            column=3,
            padx=200,
        ...
        hfb_logo_label.configure(background="white")
...
def control_games(_=0):
    ...
    ttk.Label(scrollable_frame, text="Game Publisher").grid(
        row=0, column=2, ipadx=1, ipady=1
    )
    ...
    for i in range(len(game_list)):
        ...
        ttk.Label(scrollable_frame, text=game_list[i].grate).grid(
            row=i + 1, column=3, ipadx=1, ipady=1
        )
        ttk.Label(scrollable_frame, text=game_list[i].ggenre).grid(
            row=i + 1, column=4, ipadx=1, ipady=1
        )
...
def control_users(_=0):
    ...
    ttk.Label(scrollable_frame, text="index").grid(row=0, column=0, ipadx=1, ipady=1)
    ttk.Label(scrollable_frame, text="User Full Name").grid(
        row=0, column=1, ipadx=1, ipady=1
    )
    ttk.Label(scrollable_frame, text="User Email").grid(
        row=0, column=2, ipadx=1, ipady=1
    )
    ttk.Label(scrollable_frame, text="User Type").grid(
        row=0, column=3, ipadx=1, ipady=1
    )
    ttk.Label(scrollable_frame, text="User Online").grid(
        row=0, column=4, ipadx=1, ipady=1
    )
    ttk.Label(scrollable_frame, text="User Locked").grid(
        row=0, column=5, ipadx=1, ipady=1
    )
...
def login():
    ...
    enter_admin_name_label.grid(column=0, row=0, padx=(150, 0), pady=(150, 0))
    ...
    admin_name_input.grid(column=1, row=0, pady=(150, 0))

    enter_password_label = ttk.Label(window, text="Enter Admin Password : ")
    enter_password_label.grid(column=0, row=1, padx=(150, 0), pady=(20, 0))
...
def start():
    ...
    try:
        ...
        window.iconphoto(True, hfb_logo)
        window.configure(background="white")
...
if __name__ == "__main__":
    ...
    hfb_logo = ""
    try:
        hfb_logo = Image.open("./hfb_logo.jpeg")
        hfb_logo = hfb_logo.resize((400, 400), Image.ANTIALIAS)
        hfb_logo = ImageTk.PhotoImage(hfb_logo)
    except:
        pass
    ...
    window.geometry("960x470+480+265")
    window.mainloop()
